        ...
        <div className='h-screen w-full md:w-2/4 flex flex-col items-center   bg-white'>
           ...
           <form action="" >
               <div>
                ...
                <input type="email" name="email" id="email"  className='pl-2 mt-3 ml-4  w-72 md:w-96 h-10 rounded-lg mb-2 focus:outline-none border border-slate-300'  placeholder='  Enter your email'/>
               </div>

               <div>
                <p className='text-sm ml-5 '>password</p>
                <input type="password" name="password" id="password" placeholder='  enter your password' className='ml-4 pl-2 mt-2 w-72 md:w-96  h-10 rounded-lg focus:outline-none border border-slate-300'/>
               </div>
